...
const Tasks = () => {
  return (
    <div className="bg-white w-[400px] h-[600px] ml-[550px] mt-[140px] px-4">
      <div>
      ...
      <div>
        ...
        <div className="mb-5">
        <input type="textarea" className="h-[150px] w-[250px] rounded-md border-dashed border-2 border-indigo-600 " />
        <p className="text-xs text-gray-500">drag or browser from device</p>
        </div>
      </div>
      <button className="bg-blue-900 w-[280px] h-[40px] rounded-md"> submit</button>
    </div>
  )
}
