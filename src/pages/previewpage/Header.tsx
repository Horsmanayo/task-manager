...
const Header = () => {
  return (
    <div className="h-[145px] w-[100%] bg-white shadow-md p-6 sticky top-0">
      <header className="flex justify-between">
        <div>
          ...
          <div className="relative mt-[25px]">
            <input
              ...
              className="px-4 py-2 h-[32px] w-[300px] border border-gray-300 rounded-md focus:outline-none ml-1"
            />
            <span>
              {" "}
        ...
        <div>
          ...
          <div className="flex flex-row gap-2 mt-[15px]">
            <button className="flex items-center justify-center w-[190px] h-[52px] gap-2 border border-gray-300 rounded-md px-4 py-2">
              <span>
                <BiCategory />
              </span>
              Category
            </button>
            <button className="flex items-center justify-center w-[190px] h-[52px] gap-2 border border-gray-300 rounded-md px-4 py-2 mr-2">
              <span>
                <RxHamburgerMenu />
              </span>
              Sort by deadline
